...
**Make your own Github repo named `BE_music_<YOUR_NAME>`, download this gist and include the files to the repo. Create a README.md file with simple instructions to run it.**
...
Also, use **MongoDB** for this assignment. You can either use the mongo driver or mongoose. Ruby also has some options.
